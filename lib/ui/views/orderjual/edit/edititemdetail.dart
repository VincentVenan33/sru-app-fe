...
import 'package:mjk_apps/core/networks/update_order_jual_detail_dto.dart';
import 'package:mjk_apps/core/view_models/produk/edit/edititemdetail_view_model.dart';
                                                ...
                                                Expanded(
                                                  child: Column(
                                                    children: [
                                                      ...
                                                      Spacings.verSpace(5),
                                                      TextFormField(
                                                        controller: model.directController,
                                                        onChanged: (value) {
                                                          setState(() {
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          ...
                          final bool response = await model.updateOrderJualDetailModel(
                            ...
                            nomormhbarang: model.orderjualdetail?.nomormhbarang ?? 0,
                            nomormhsatuan: model.selectedSatuanBarang?.nomor ?? 0,
                            qty: int.parse(model.qtyController.text),
                            netto: int.parse(model.nettoController.text),
                            disctotal: int.parse(model.totalController.text),
                            discdirect: _discdirect,
                            disc3: _disc3,
                            disc2: _disc2,
                            disc1: _disc1,
                            satuanqty: model.selectedSatuanBarang?.nama ?? '',
                            isi: int.parse(model.isiController.text),
                            satuanisi: model.orderjualdetail?.satuanisi ?? '',
                            harga: _harga,
                            subtotal: int.parse(model.subtotalController.text),
