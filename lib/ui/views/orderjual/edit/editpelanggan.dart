...
class EditPelangganOrderJual extends ConsumerStatefulWidget {
  const EditPelangganOrderJual({
    super.key,
    required this.viewModel,
  });
  final UpdateOrderJualViewModel viewModel;
  @override
  ConsumerState<EditPelangganOrderJual> createState() => _EditPelangganOrderJualState();
}

class _EditPelangganOrderJualState extends ConsumerState<EditPelangganOrderJual> {
