...
class AddDetailOrderParam {
  const AddDetailOrderParam({
    required this.nomor,
    required this.mode,
  });
...
class AddDetailOrderJual extends ConsumerStatefulWidget {
  const AddDetailOrderJual({
    super.key,
    required this.param,
  });

  final AddDetailOrderParam param;

  @override
  ConsumerState<AddDetailOrderJual> createState() => _AddDetailOrderJualState();
}

class _AddDetailOrderJualState extends ConsumerState<AddDetailOrderJual> {
  int _qty = 0;
  int _netto = 0;
  int _disctotal = 0;
  int _discdirect = 0;
