...
class AddDesa extends ConsumerStatefulWidget {
  const AddDesa({
    super.key,
    required this.viewModel,
  });
  final AddCustomerViewModel viewModel;
  @override
  ConsumerState<AddDesa> createState() => _AddDesaState();
}

class _AddDesaState extends ConsumerState<AddDesa> {
  ...
  Widget build(BuildContext context) {
    return ViewModel<AddCustomerViewModel>(
      ...
      onModelReady: (AddCustomerViewModel model) => model.fetchDesa(reload: true),
